...
<head>
  ...
  <title>USTHB Education — Gestion des Enseignants</title>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .sidebar {
      ...
      position: fixed; top: 0; left: 0; height: 100vh; gap: 6px;
    }
    ...
    .search-bar {
      ...
      border-radius: 100px; padding: 12px 20px; margin-bottom: 20px;
    }
    ...
    .etat-dot { display: flex; align-items: center; gap: 6px; font-size: 13px; font-weight: 600; }
...
<body>
  ...
  <aside class="sidebar">
    ...
    <a href="enseignants.php" class="nav-item active">
  ...
  <main class="main">
    ...
    <p class="page-sub">Gérez les informations des enseignants : ajout, modification, suppression et consultation des profils en toute simplicité.</p>

    <p class="section-label">Recherche ton enseignant</p>
    <div class="search-bar">
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg>
      <input type="text" placeholder="Rechercher enseignant" id="searchInput" onkeyup="searchTable()"/>
    </div>

    <div class="actions-row">
      <a href="ajouter_enseignant.php" class="btn-add">+ &nbsp; Ajouter enseignant</a>
      <a href="modifier_enseignant.php" class="btn-edit">
    ...
    <p class="table-label">Liste des enseignants :</p>
    <div class="table-wrap">
      <table id="enseignantsTable">
        ...
        <tbody>
          <tr>
            <td>#001</td>
            <td><strong>ENS001</strong></td>
            <td class="td-name">Benali Mohammed</td>
            <td>benali@usthb.dz</td>
            <td>Doctorat</td>
            <td><div class="etat-dot"><div class="dot dot-green"></div>Actif</div></td>
            <td><div class="td-actions">
              <a href="modifier_enseignant.php" class="action-btn edit"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg></a>
          ...
          <tr>
            <td>#002</td>
            <td><strong>ENS002</strong></td>
            <td class="td-name">Meziane Fatima</td>
            <td>meziane@usthb.dz</td>
            <td>Doctorat</td>
            <td><div class="etat-dot"><div class="dot dot-green"></div>Actif</div></td>
            <td><div class="td-actions">
              <a href="modifier_enseignant.php" class="action-btn edit"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg></a>
          ...
          <tr>
            <td>#003</td>
            <td><strong>ENS003</strong></td>
            <td class="td-name">Khelil Rachid</td>
            <td>khelil@usthb.dz</td>
            <td>Magistère</td>
            <td><div class="etat-dot"><div class="dot dot-gray"></div>Non actif</div></td>
            <td><div class="td-actions">
              <a href="modifier_enseignant.php" class="action-btn edit"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg></a>
              <a href="#" class="action-btn del"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/></svg></a>
            </div></td>
  ...
  <script>
    function searchTable() {
      ...
      const rows = document.querySelectorAll('#enseignantsTable tbody tr');
      rows.forEach(row => {
