...
<head>
  ...
  <title>USTHB Education — Ajouter Enseignant</title>
...
<body>
  ...
  <main class="main">
    <h1 class="page-title">Ajouter un Enseignant</h1>
    <p class="page-sub">Remplissez ce formulaire pour ajouter un nouvel enseignant.</p>
