...
<head>
  ...
  <title>USTHB Education — Modifier Module</title>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .form-group input { width:100%; padding:13px 16px; border:1.5px solid var(--border); border-radius:8px; font-size:14px; font-family:'Manrope',sans-serif; color:var(--text); background:var(--white); outline:none; transition:border-color .2s,box-shadow .2s; }
    .form-group input::placeholder { color:#9CA3AF; }
    .form-group input:focus { border-color:var(--blue); box-shadow:0 0 0 3px rgba(35,65,200,0.1); }
...
<body>
  ...
  <main class="main">
    <h1 class="page-title">Modifier un Module</h1>
    <p class="page-sub">Remplissez ce formulaire pour modifier les informations du module.</p>
    <form action="modifier_module.php" method="POST">
      <div class="form-group"><label>Code module</label><input type="text" name="code" placeholder="Entrer Code module" required/></div>
      <div class="form-group"><label>Intitulé</label><input type="text" name="intitule" placeholder="Entrer Intitulé" required/></div>
      <div class="form-group"><label>Coefficient</label><input type="number" name="coefficient" placeholder="Entrer Coefficient" required/></div>
      <div class="form-group"><label>Crédit</label><input type="number" name="credit" placeholder="Entrer Crédit" required/></div>
      <div class="form-group"><label>Type</label><input type="text" name="type" placeholder="Entrer Type (ex: Cours + TP)" required/></div>
      <div class="form-group"><label>Enseignant</label><input type="text" name="enseignant" placeholder="Entrer Enseignant" required/></div>
      <div class="btn-row">
        <button type="submit" class="btn-submit">Enregistrer</button>
        <a href="modules.php" class="btn-cancel">Annuler</a>
      </div>
    </form>
  </main>
</body>
