...
<head>
  ...
  <title>USTHB Education — Ajouter Module</title>
...
<body>
  ...
  <main class="main">
    <h1 class="page-title">Ajouter un Module</h1>
    <p class="page-sub">Remplissez ce formulaire pour ajouter un nouveau module.</p>
