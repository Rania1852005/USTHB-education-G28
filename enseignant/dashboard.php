...
<head>
  ...
  <title>USTHB Education — Enseignant</title>
  <link rel="icon" type="image/png" href="../assets/img/logo_usthb.png">
  <link href="https://fonts.googleapis.com/css2?family=Manrope:wght@400;500;600;700;800&display=swap" rel="stylesheet"/>
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    :root { --orange:#F97316; --orange-dark:#ea6a0a; --orange-light:#FFF7ED; --text:#111827; --muted:#6B7280; --border:#E5E7EB; --bg:#F3F4F6; --white:#ffffff; --green:#22C55E; }
    ...
    td { padding:16px; font-size:14px; color:var(--text); border-top:1px solid var(--border); font-weight:500; }
    tr:hover td { background:#F9FAFB; }
    .td-name { font-weight:700; }
    .badge-done { background:#DCFCE7; color:#16A34A; border:1.5px solid #16A34A; border-radius:100px; padding:4px 12px; font-size:12px; font-weight:700; }
...
<body>
  <aside class="sidebar">
    ...
    <a href="dashboard.php" class="nav-item active"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>Mes modules</a>
    <a href="saisie_notes.php" class="nav-item"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>Saisie des Notes</a>
  ...
  <main class="main">
    <h1 class="page-title">Bonjour, Enseignants</h1>
    ...
    <div class="table-wrap">
      <table id="modulesTable">
        <thead><tr><th>Code</th><th>Intitulé</th><th>Coefficient</th><th>Crédit</th><th>Type</th><th>Statut</th></tr></thead>
        <tbody>
          <tr><td>INF101</td><td class="td-name">Introduction à la programmation</td><td>3</td><td>5</td><td>Cours + TP</td><td><span class="badge-done">Done</span></td></tr>
          <tr><td>INF102</td><td class="td-name">Algorithmique</td><td>4</td><td>6</td><td>Cours + TD</td><td><span class="badge-done">Done</span></td></tr>
          <tr><td>INF103</td><td class="td-name">Base de données</td><td>3</td><td>5</td><td>Cours + TP</td><td><span class="badge-done">Done</span></td></tr>
          <tr><td>INF104</td><td class="td-name">Programmation Web</td><td>3</td><td>5</td><td>Cours + TP</td><td><span class="badge-done">Done</span></td></tr>
          <tr><td>INF105</td><td class="td-name">Systèmes d'exploitation</td><td>4</td><td>6</td><td>Cours + TD</td><td><span class="badge-done">Done</span></td></tr>
        </tbody>
      </table>
