...
<head>
  ...
  <title>USTHB Education — Liste des Étudiants</title>
  <link rel="icon" type="image/png" href="../assets/img/logo_usthb.png">
  <link href="https://fonts.googleapis.com/css2?family=Manrope:wght@400;500;600;700;800&display=swap" rel="stylesheet"/>
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    :root { --orange:#F97316; --text:#111827; --muted:#6B7280; --border:#E5E7EB; --bg:#F3F4F6; --white:#ffffff; --green:#22C55E; }
    ...
    .page-title { font-size:32px; font-weight:800; color:var(--text); margin-bottom:32px; }
...
<body>
  <aside class="sidebar">
    ...
    <a href="liste_etudiants.php" class="nav-item active"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c3 3 9 3 12 0v-5"/></svg>liste des étudiants</a>
  </aside>
  <main class="main">
